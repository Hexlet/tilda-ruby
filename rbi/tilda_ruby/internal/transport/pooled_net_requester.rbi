      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                TildaRuby::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: TildaRuby::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: TildaRuby::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
