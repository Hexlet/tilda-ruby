    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data:
              T.any(Tilda::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick:
              T.nilable(
                T.any(
                  Symbol,
      ...
      class << self
        ...
        # @api private
        sig do
          params(parsed: Tilda::Internal::Util::ParsedUri).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: Tilda::Internal::Util::ParsedUri,
            rhs: Tilda::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Tilda::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Tilda::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
