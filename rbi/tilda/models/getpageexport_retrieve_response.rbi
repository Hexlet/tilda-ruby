  ...
  module Models
    module GetpageexportRetrieveResponse
      ...
      Variants =
        T.type_alias do
          T.any(
            Tilda::Models::GetpageexportRetrieveResponse::UnionMember0,
            Tilda::Error
          )
        end
      ...
      class UnionMember0 < Tilda::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result::OrHash
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            result:
              Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result::OrHash,
            status:
              Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Status::OrSymbol
        ...
        class Result < Tilda::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result::Css
                ]
              )
            )
          end
          ...
          sig do
            params(
              css:
                T::Array[
                  Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result::Css::OrHash
                ]
            ).void
          end
          attr_writer :css
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result::J
                ]
              )
            )
          end
          ...
          sig do
            params(
              js:
                T::Array[
                  Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Result::J::OrHash
                ]
            ).void
          end
          attr_writer :js
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Tilda::Models::GetpageexportRetrieveResponse::UnionMember0::Status
              )
            end
      ...
      sig do
        override.returns(
          T::Array[Tilda::Models::GetpageexportRetrieveResponse::Variants]
        )
      end
      def self.variants
      end
