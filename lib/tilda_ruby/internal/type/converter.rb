    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { TildaRuby::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { TildaRuby::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            TildaRuby::FilePart.new(value)
          in TildaRuby::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in TildaRuby::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [TildaRuby::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: TildaRuby::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in TildaRuby::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in TildaRuby::Internal::Type::Converter
              ...
              TildaRuby::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(TildaRuby::Internal::Type::Converter, T::Class[T.anything]) }
        end
