...
class TildaRuby::Test::PrimitiveModelTest < Minitest::Test
  A = TildaRuby::Internal::Type::ArrayOf[-> { Integer }]
  H = TildaRuby::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < TildaRuby::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      TildaRuby::Internal::Type::Unknown,
      TildaRuby::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => TildaRuby::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [TildaRuby::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [TildaRuby::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [TildaRuby::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = TildaRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        TildaRuby::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [TildaRuby::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [TildaRuby::Internal::Type::Boolean, true] => true,
      [TildaRuby::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => TildaRuby::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        TildaRuby::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = TildaRuby::Internal::Type::Converter.new_coerce_state
      TildaRuby::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        TildaRuby::Internal::Type::Converter.dump(target, input, state: state)
...
class TildaRuby::Test::EnumModelTest < Minitest::Test
  class E0
    include TildaRuby::Internal::Type::Enum
...
class TildaRuby::Test::CollectionModelTest < Minitest::Test
  A1 = TildaRuby::Internal::Type::ArrayOf[-> { Integer }]
  H1 = TildaRuby::Internal::Type::HashOf[Integer]

  A2 = TildaRuby::Internal::Type::ArrayOf[H1]
  H2 = TildaRuby::Internal::Type::HashOf[-> { A1 }]

  A3 = TildaRuby::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = TildaRuby::Internal::Type::HashOf[Integer, nil?: true]
...
class TildaRuby::Test::BaseModelTest < Minitest::Test
  class M1 < TildaRuby::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < TildaRuby::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < TildaRuby::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, TildaRuby::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = TildaRuby::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = TildaRuby::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(TildaRuby::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue TildaRuby::Errors::ConversionError => e
...
class TildaRuby::Test::UnionTest < Minitest::Test
  class U0
    include TildaRuby::Internal::Type::Union
  ...
  class M2 < TildaRuby::Internal::Type::BaseModel
  ...
  class M4 < TildaRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, TildaRuby::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < TildaRuby::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, TildaRuby::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class TildaRuby::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include TildaRuby::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [TildaRuby::Internal::Type::Unknown, TildaRuby::Internal::Type::Unknown] => true,
      [TildaRuby::Internal::Type::Boolean, TildaRuby::Internal::Type::Boolean] => true,
      [TildaRuby::Internal::Type::Unknown, TildaRuby::Internal::Type::Boolean] => false,
...
class TildaRuby::Test::MetaInfoTest < Minitest::Test
  A1 = TildaRuby::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = TildaRuby::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
