...
class TildaTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    tilda = Tilda::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(Tilda::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    tilda = Tilda::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    ...
    tilda = Tilda::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Tilda::Errors::APIConnectionError) do
    ...
    assert_requested(:any, "http://localhost/redirected", times: Tilda::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Tilda::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Tilda::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
