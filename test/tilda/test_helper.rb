...
class Tilda::Test::SingletonClient < Tilda::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Tilda::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Tilda::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @tilda = Tilda::Test::SingletonClient.instance
  end
