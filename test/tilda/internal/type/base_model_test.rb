...
class Tilda::Test::PrimitiveModelTest < Minitest::Test
  A = Tilda::Internal::Type::ArrayOf[-> { Integer }]
  H = Tilda::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Tilda::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Tilda::Internal::Type::Unknown,
      Tilda::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Tilda::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Tilda::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Tilda::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Tilda::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Tilda::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Tilda::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Tilda::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Tilda::Internal::Type::Boolean, true] => true,
      [Tilda::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Tilda::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Tilda::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Tilda::Internal::Type::Converter.new_coerce_state
      Tilda::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Tilda::Internal::Type::Converter.dump(target, input, state: state)
...
class Tilda::Test::EnumModelTest < Minitest::Test
  class E0
    include Tilda::Internal::Type::Enum
...
class Tilda::Test::CollectionModelTest < Minitest::Test
  A1 = Tilda::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Tilda::Internal::Type::HashOf[Integer]

  A2 = Tilda::Internal::Type::ArrayOf[H1]
  H2 = Tilda::Internal::Type::HashOf[-> { A1 }]

  A3 = Tilda::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Tilda::Internal::Type::HashOf[Integer, nil?: true]
...
class Tilda::Test::BaseModelTest < Minitest::Test
  class M1 < Tilda::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Tilda::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Tilda::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Tilda::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Tilda::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Tilda::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Tilda::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Tilda::Errors::ConversionError => e
...
class Tilda::Test::UnionTest < Minitest::Test
  class U0
    include Tilda::Internal::Type::Union
  ...
  class M2 < Tilda::Internal::Type::BaseModel
  ...
  class M4 < Tilda::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Tilda::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Tilda::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Tilda::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Tilda::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Tilda::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Tilda::Internal::Type::Unknown, Tilda::Internal::Type::Unknown] => true,
      [Tilda::Internal::Type::Boolean, Tilda::Internal::Type::Boolean] => true,
      [Tilda::Internal::Type::Unknown, Tilda::Internal::Type::Boolean] => false,
...
class Tilda::Test::MetaInfoTest < Minitest::Test
  A1 = Tilda::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Tilda::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
